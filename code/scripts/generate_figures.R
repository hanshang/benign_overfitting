...
out_files <- c(
  plot_scaled_maha_gamma(file.path(plots_dir, "Fig_1.png")),
  plot_theorem1_identity(file.path(plots_dir, "Fig_2a.png")),
  plot_theorem1_compoundsymmetric(file.path(plots_dir, "Fig_2b.png")),
  plot_sim1(file.path(plots_dir, "Fig_4.png")),
  plot_empirical_identity_delta(file.path(plots_dir, "Fig_5.png")),
  plot_empirical_compound_symmetric(file.path(plots_dir, "Fig_6a.png")),
  plot_compound_symmetric_theoretical(file.path(plots_dir, "Fig_6b.png")),
  plot_ar1_empirical(file.path(plots_dir, "Fig_7a.png")),
  plot_ar1_theoretical(file.path(plots_dir, "Fig_7b.png")),
  plot_uniform_distribution(file.path(plots_dir, "Fig_8a.png")),
  plot_poisson_distribution(file.path(plots_dir, "Fig_8b.png")),
  plot_tdist_identity_df(file.path(plots_dir, "Fig_9a.png")),
  plot_tdist_cs_df(file.path(plots_dir, "Fig_9b.png")),
  plot_flipping_y(file.path(plots_dir, "Fig_10.png")),
  plot_signal_to_noise(file.path(plots_dir, "Fig_11.png")),
  plot_redundant_features(file.path(plots_dir, "Fig_12.png")),
  plot_mahalanobis_realdata(file.path(plots_dir, "Fig_13.png")),
  plot_arcene_random_sample(file.path(plots_dir, "Fig_14.png")),
  plot_arcene_comparison(file.path(plots_dir, "Fig_15.png")),
  plot_arcene_pca(file.path(plots_dir, "Fig_16.png")),
  plot_wang_maha(file.path(plots_dir, "Fig_B1a.png")),
  plot_wang_identity_delta(file.path(plots_dir, "Fig_B1b.png")),
  plot_wang_compoundsymmetric(file.path(plots_dir, "Fig_B1c.png")),
  plot_wang_ar1(file.path(plots_dir, "Fig_B1d.png"))
)
